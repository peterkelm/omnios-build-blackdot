...
download_source () {
    ...
    git clone https://github.com/rembo10/headphones.git ${PROG}
...
make_install() {
    ...
    logcmd cp -r ${TMPDIR}/src/${PROG}/* ${DESTDIR}${PREFIX}/dlmgr/headphones/ || \
        logerr "------ Failed to copy app."
    logcmd cp -r ${SRCDIR}/files/headphones.xml $DESTDIR/lib/svc/manifest/network/ || \
